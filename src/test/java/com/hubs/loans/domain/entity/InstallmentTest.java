...
public class InstallmentTest {
    ...
    @Test
    void not_is_paid_returns_true_when_installment_not_paid() {
    ...
    @Test
    void not_is_paid_returns_false_when_installment_paid() {
    ...
    @Test
    void calculate_days_after_due_date_returns_correct_days_count() {
    ...
    @Test
    void calculate_days_after_due_date_returns_zero_when_due_date_did_not_pass() {
    ...
    @Test
    void calculate_days_after_due_date_returns_zero_when_due_date_is_today() {
    ...
    @Test
    void calculate_days_before_due_date_returns_correct_days_count() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().plusDays(5)).build();
    ...
    @Test
    void calculate_days_before_due_date_returns_zero_when_due_date_did_pass() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().minusDays(5)).build();
    ...
    @Test
    void calculate_days_before_due_date_returns_zero_when_due_date_is_today() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).build();
    ...
    @Test
    void is_paid_late_returns_true_when_installment_is_paid_late() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().minusDays(5)).build();
    ...
    @Test
    void is_paid_late_returns_false_when_installment_is_paid_early() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().plusDays(5)).build();
    ...
    @Test
    void is_paid_late_returns_false_when_installment_is_paid_on_time() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).build();
    ...
    @Test
    void is_paid_early_returns_true_when_installment_is_paid_early() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().plusDays(5)).build();
    ...
    @Test
    void is_paid_early_returns_false_when_installment_is_paid_late() {
        Installment installment = Installment.builder().dueDate(LocalDate.now().minusDays(5)).build();
    ...
    @Test
    void is_paid_early_returns_false_when_installment_is_paid_on_time() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).build();
    ...
    @Test
    void is_payable_today_returns_true_when_installment_due_date_is_within_three_months() {
    ...
    @Test
    void is_payable_today_returns_false_when_installment_due_date_is_not_within_three_months() {
    ...
    @Test
    void is_payable_today_returns_true_when_installment_due_date_before_current_date() {
    ...
    @Test
    void calculate_penalized_amount_returns_correct_amount() {
    ...
    @Test
    void calculate_discounted_amount_returns_correct_amount() {
        Installment installment =
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_on_time_with_same_amount_of_installment_amount() {
    ...
    @Test
    void is_payable_with_amount_returns_false_when_customer_pays_on_time_with_missing_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_on_time_with_more_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_early_with_same_amount_of_installment_amount() {
        Installment installment =
                Installment.builder()
    ...
    @Test
    void is_payable_with_amount_returns_false_when_customer_pays_early_with_missing_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_early_with_discounted_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_early_with_more_amount_than_discounted_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_false_when_customer_pays_late_with_same_amount_of_installment_amount() {
        Installment installment =
                Installment.builder()
    ...
    @Test
    void is_payable_with_amount_returns_false_when_customer_pays_late_with_missing_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_late_with_penalized_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void is_payable_with_amount_returns_true_when_customer_pays_late_with_more_amount_than_penalized_amount() {
        Installment installment = Installment.builder().dueDate(LocalDate.now()).amount(BigDecimal.valueOf(10000)).build();
    ...
    @Test
    void pay_with_discount_keeps_installment_state_consistent_and_decreases_its_customers_used_credit_limit_properly() {
    ...
    @Test
    void pay_with_penalty_keeps_installment_state_consistent_and_decreases_its_customers_used_credit_limit_properly() {
        Customer customer = new Customer(
                UUID.randomUUID(),
                "John",
                "Doe",
    ...
    @Test
    void pay_ordinary_keeps_installment_state_consistent_and_decreases_its_customers_used_credit_limit_properly() {
        Customer customer = new Customer(
                UUID.randomUUID(),
                "John",
                "Doe",
    ...
    @Test
    void pay_pays_with_discount_when_installment_is_paid_early() {
        Customer customer = new Customer(
                UUID.randomUUID(),
                "John",
                "Doe",
    ...
    @Test
    void pay_pays_with_penalty_when_installment_is_paid_late() {
        Customer customer = new Customer(
                UUID.randomUUID(),
                "John",
                "Doe",
    ...
    @Test
    void pay_pays_ordinary_when_installment_is_paid_on_time() {
        Customer customer = new Customer(
                UUID.randomUUID(),
                "John",
                "Doe",
