...
public class CreditLimitTest {
    ...
    @Test
    public void throws_invalid_credit_limit_exception_when_used_credit_limit_is_less_than_zero() {
        assertThrows(
    ...
    @Test
    public void throws_invalid_credit_limit_exception_when_credit_limit_is_less_than_zero() {
        assertThrows(
                InvalidCreditLimitException.class,
    ...
    @Test
    public void throws_invalid_credit_limit_exception_when_used_credit_limit_and_credit_limit_is_less_than_zero() {
        assertThrows(
                InvalidCreditLimitException.class,
    ...
    @Test
    public void instantiates_when_arguments_are_equal_to_zero() {
    ...
    @Test
    public void instantiates_when_arguments_are_greater_than_zero() {
            CreditLimit creditLimit = new CreditLimit(BigDecimal.valueOf(1), BigDecimal.valueOf(1));
            assertInstanceOf(CreditLimit.class, creditLimit);
    }

    @Test
    public void is_insufficient_returns_false_when_credit_limit_is_sufficient() {
    ...
    @Test
    public void is_insufficient_returns_true_when_credit_limit_is_insufficient() {
        CreditLimit creditLimit = new CreditLimit(BigDecimal.valueOf(0), BigDecimal.valueOf(10000));
