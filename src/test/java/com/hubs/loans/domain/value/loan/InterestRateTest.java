...
public class InterestRateTest {
    ...
    @Test
    void throws_invalid_interest_rate_exception_when_interest_rate_less_than_min() {
    ...
    @Test
    void throws_invalid_interest_rate_exception_when_interest_rate_greater_than_max() {
    ...
    @Test
    void instantiates_when_interest_rate_between_min_and_max() {
