...
public class NumberOfInstallmentsTest {
    ...
    @Test
    public void accepted_installment_numbers_are_correct() {
        assertEquals(NumberOfInstallments.ACCEPTED_INSTALLMENT_NUMBERS, List.of(6, 9, 12, 24));
    }

    @Test
    public void throws_invalid_number_of_installments_exception_when_installment_numbers_are_incorrect() {
